...
export default {
  data: () => ({
    ...
    items: [
      {
        subtitle: `Compañeros esta es la mejor interfas grafica de whatsapp`,
        title: 'Banano Programer',
      },
      {
        subtitle: `Hoy yo gasto bueños con cafe.`,
        title: 'Hector Maya',
      },
      {
        subtitle: 'el desarollo es todo un exito se logro el frontend',
        title: 'Jhony Sanabria',
      },
      {
        subtitle:
          'Muchachos ese proyecto esta quedando muy bien',
        title: 'Instructor Edilfredo',
      },
      {
        subtitle:
          'Me preocupa la seguridad de ese proyecto, no creo que funcione',
        title: 'Instructor Eli',
      },
      {
